    ...
    <div className="banner" style={bannerStyle}>
      <div className="banner-content">
        <div className="text-section">
          <h1 className="banner-text">"Now <span style={{color:"turquoise"}}>Services</span> <br></br>at your door steps" </h1>
          <p className="banner-description">
            Explore <span style={{color:"turquoise",fontWeight: 'bold'}}>MistryHub</span>. Your One-Stop Destination for Reliable Services
